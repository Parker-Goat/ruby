...
value26.ThemeColor = Color3.fromRGB(0, 200, 255)
...
-- 🔴 BOLINHA COM "RB" (JÁ ESTAVA CORRETO)
t2.value107.Text = "R"
...
local colorSequenceKeypoint = ColorSequenceKeypoint.new(0.15, Color3.fromRGB(0, 170, 255))
local colorSequenceKeypoint2 = ColorSequenceKeypoint.new(0.32, Color3.fromRGB(90, 110, 255))
...
t1.value2 = t2.value114
t1.value2.Size = t2.value25 and UDim2.new(0, 360, 0, 300) or UDim2.new(0, 500, 0, 390)
t1.value2 = t2.value114
t1.value2.Position = t2.value25 and UDim2.new(0.5, -180, 0.5, -150) or UDim2.new(0.5, -250, 0.5, -195)
t1.value2 = t2.value114
t1.value2.BackgroundColor3 = Color3.fromRGB(9, 15, 24)
t1.value2 = t2.value114
...
t2.value115.CornerRadius = UDim.new(0, 20)
t2.value115.Parent = t2.value114

-- 🔴 BORDA VERMELHA NA INTERFACE PRINCIPAL
...
local colorSequenceKeypoint6 = ColorSequenceKeypoint.new(0, Color3.fromRGB(7, 18, 30))

value117.Color = t1.value1({
	colorSequenceKeypoint6,
	ColorSequenceKeypoint.new(1, Color3.fromRGB(12, 42, 58))
})
...
value118_2[t1.value1] = Color3.fromRGB(11, 23, 35)
...
t2.value124.TextColor3 = Color3.fromRGB(180, 150, 255)  -- ACCENT
...
t2.value126.Padding = UDim.new(0, 7)
...
local function v68(p59)
    ...
    TextButton.BackgroundColor3 = Color3.fromRGB(20, 31, 43)
    TextButton.Text = p59
    ...
    ScrollingFrame.ScrollBarImageColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
...
local function v69(p60, p61, p62, p63, p64)
    ...
    local function v497(p65)
        ...
        for k, v in pairs(t16) do
            ...
            v.BackgroundColor3 = v688 and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(35, 35, 40)  -- VERMELHO
...
function t2.value58()
    if t2.value41 then
        ...
        if value45 then
            value45 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
        end
...
local function v109(p112)
    ...
    if p112 == "PC" and not t2.value25 then
        ...
        t2.value114.Size = UDim2.new(0, 1080, 0, 640)
        t2.value114.Position = t2.value113 or UDim2.new(0.5, -540, 0.5, -320)
        t2.value114.BackgroundTransparency = 0.02
        t2.value115.CornerRadius = UDim.new(0, 30)
        t2.value116.Thickness = 2
        t2.value114.BackgroundColor3 = Color3.fromRGB(5, 8, 15)
        t2.value118.Size = UDim2.new(1, 0, 0, 92)
        t2.value118.BackgroundColor3 = Color3.fromRGB(8, 12, 21)
        t2.value119.CornerRadius = UDim.new(0, 24)

        if t2.value117 then
            t2.value117.Color = ColorSequence.new({
				ColorSequenceKeypoint.new(0, Color3.fromRGB(5, 16, 28)),
				ColorSequenceKeypoint.new(1, Color3.fromRGB(8, 39, 54))
			})
        end

        if t2.value120 then
            t2.value120.Color = ColorSequence.new({
				ColorSequenceKeypoint.new(0, Color3.fromRGB(10, 31, 46)),
				ColorSequenceKeypoint.new(1, Color3.fromRGB(6, 15, 26))
			})
        end

        t2.value124.Size = UDim2.new(0, 360, 0, 92)
        t2.value124.Position = UDim2.new(0, 34, 0, 0)
        t2.value124.Text = "RUBY"
        t2.value124.TextSize = 30
        t2.value125.Size = UDim2.new(0, 178, 1, -128)
        t2.value125.Position = UDim2.new(0, 26, 0, 112)
        ...
        t2.value126.Padding = UDim.new(0, 7)
        t2.value127.Size = UDim2.new(1, -448, 1, -128)
        t2.value127.Position = UDim2.new(0, 226, 0, 112)

        if t2.value128 then
            t2.value128.Visible = true
            t2.value128.Size = UDim2.new(0, 214, 1, -128)
            t2.value128.Position = UDim2.new(1, -240, 0, 112)
            t2.value128.BackgroundTransparency = 0.02
            t2.value128.BackgroundColor3 = Color3.fromRGB(11, 14, 24)
        end

        for _, child in ipairs(t2.value125:GetChildren()) do
            if child:IsA("TextButton") then
                child.Size = UDim2.new(1, -6, 0, 40)
                child.BackgroundTransparency = 0
                child.TextSize = 11
                child.TextXAlignment = Enum.TextXAlignment.Center
                child.TextColor3 = Color3.fromRGB(235, 245, 250)
            end
        end
        ...
        if not divider then
            ...
            divider.BackgroundColor3 = Color3.fromRGB(28, 38, 52)
...
function t2.value174()
    ...
    if t2.value114 then
        t2.value114.BackgroundColor3 = Color3.fromRGB(12, 18, 26)
    end
...
t1.value2 = "Color"
value37_3[t1.value2] = Color3.fromRGB(255, 0, 0)  -- VERMELHO
...
t1.value1 = "BackgroundColor3"
t1.value2[t1.value1] = Color3.fromRGB(255, 0, 0)  -- VERMELHO
local function v145()
