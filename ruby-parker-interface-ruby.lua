...
value26.ThemeColor = Color3.fromRGB(224, 17, 95)
...
UIStroke3.Color = Color3.fromRGB(155, 17, 30)  -- ACCENT
...
local colorSequenceKeypoint2 = ColorSequenceKeypoint.new(0.32, Color3.fromRGB(155, 17, 30))
