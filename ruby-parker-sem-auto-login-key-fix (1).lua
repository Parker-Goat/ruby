...
t2.value116.Color = Color3.fromRGB(120, 80, 255)  -- ACCENT
t2.value116.Thickness = 3  -- MAIS ESPESSA
...
local function v67(p46, p47, p48, p49)
    ...
    local function v461(p50)
        ...
        t2.value1:Create(TextButton, TweenInfo.new(0.3, Enum.EasingStyle.Quad), {
			BackgroundColor3 = u460 and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(40, 40, 40)  -- VERMELHO
		}):Play()
...
function t1.value2(p51, p52, p53, p54, p55, p56, p57)
    ...
    Frame10.BackgroundColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
...
local function v69(p60, p61, p62, p63, p64)
    ...
    UIStroke4.Color = Color3.fromRGB(255, 0, 0)  -- VERMELHO
...
t2.value152.BackgroundColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
...
t2.value154.BackgroundColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
...
t2.value156.BackgroundColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
...
local function v92()
    t2.value158.BackgroundColor3 = t2.value26.AutoLongDir == "ESQUERDA" and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(40, 40, 40)  -- VERMELHO
    t2.value159.BackgroundColor3 = t2.value26.AutoLongDir == "DIREITA" and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(40, 40, 40)  -- VERMELHO
end
v92()
...
t2.value160.BackgroundColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
...
function t2.value56()
    if t2.value39 then
        ...
        t2.value39.BackgroundColor3 = t2.value26.HitboxEnabled and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(20, 20, 20)  -- VERMELHO
        t2.value39.Text = not t2.value26.HitboxEnabled and "HIT OFF" or "HIT ON"

        if t2.value40 then
            t2.value40.Color = Color3.fromRGB(255, 0, 0)  -- VERMELHO
        end
    end
end
...
function t2.value58()
    if t2.value41 then
        ...
        if t2.value42 then
            t2.value42.Color = Color3.fromRGB(255, 0, 0)  -- VERMELHO
        end
    end
end
...
function t2.value59()
    if t2.value43 then
        ...
        t2.value43.BackgroundColor3 = t2.value26.LeedFeat and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(20, 20, 20)  -- VERMELHO
        t2.value43.Text = not t2.value26.LeedFeat and "LEED OFF" or "LEED"

        if t2.value44 then
            t2.value44.Color = Color3.fromRGB(255, 0, 0)  -- VERMELHO
        end
    end
end
...
function t2.value49()
    if t2.value47 then
        ...
        t2.value47.BackgroundColor3 = t2.value26.AutoLong and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(20, 20, 20)  -- VERMELHO
        t2.value47.Text = not t2.value26.AutoLong and "LONG OFF" or "LONG ON"

        if t2.value48 then
            t2.value48.Color = Color3.fromRGB(255, 0, 0)  -- VERMELHO
        end
    end
...
UIStroke5.Color = Color3.fromRGB(255, 0, 0)  -- VERMELHO
...
function t2.value174()
    t2.value116.Color = Color3.fromRGB(255, 0, 0)  -- VERMELHO (FIXO)
    ...
    if t2.value26.ThemeColor == Color3.fromRGB(255, 255, 255) then
        ...
        t2.value124.TextColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
    end
    if t2.value134.Visible then
        t2.value133.BackgroundColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
    end
    if t2.value136.Visible then
        t2.value135.BackgroundColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
    end
    if t2.value138.Visible then
        t2.value137.BackgroundColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
    end
    if t2.value140.Visible then
        t2.value139.BackgroundColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
    end
    if t2.value142.Visible then
        t2.value141.BackgroundColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
    end
    if t2.value144.Visible then
        t2.value143.BackgroundColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
    end
    if t2.value146.Visible then
        t2.value145.BackgroundColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
    end
    if t2.value149.Visible then
        t2.value148.BackgroundColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
    end
        ...
        for _, child in pairs(v610:GetChildren()) do
            for _, descendant in pairs(child:GetDescendants()) do
                if descendant.Name == "SliderFill" and descendant:IsA("Frame") then
                    descendant.BackgroundColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
                end
            end
    ...
    for v618, v619 in ipairs(t2.value104:GetDescendants()) do
        ...
        if v619:IsA("ScrollingFrame") then
            v619.ScrollBarImageColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
        end

        if v619.Name == "RUBYHUBThemeButton" and v619:IsA("TextButton") then  -- ALTERADO
            v619.BackgroundColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
        end
    end
    if t2.value35 then
        t2.value35.BackgroundColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
    end
    if t2.value36 then
        t2.value36.BackgroundColor3 = Color3.fromRGB(12, 12, 14)
    end
    if t2.value37 then
        t2.value37.Color = Color3.fromRGB(255, 0, 0)  -- VERMELHO
    end
    if t2.value129 then
        t2.value129.Color = Color3.fromRGB(255, 0, 0)  -- VERMELHO
    end
    if t2.value131 then
        t2.value131.Color = Color3.fromRGB(255, 0, 0)  -- VERMELHO
    end
    if t2.value130 then
        t2.value130.TextColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
    end
...
local function v144(p115, p116)
    ...
    p115.BackgroundColor3 = Color3.fromRGB(255, 0, 0)  -- VERMELHO
    p116.Visible = true
    t2.value174()
end
...
function t2.value38(p117)
    ...
    UIStroke6.Color = Color3.fromRGB(255, 0, 0)  -- VERMELHO
