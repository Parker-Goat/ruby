...
local function RubyScoreStop()
    ...
    for i, connection in pairs(RubyScoreConnections) do
        if connection then
...
local function RubyScoreStart()
    ...
    local function trigger(position)
    ...
    RubyScoreConnections[1] = workspace.ChildAdded:Connect(checkIndicator)
    RubyScoreConnections[2] = workspace.DescendantAdded:Connect(checkIndicator)
...
v69(t2.value181, "Effect Select", {
    ...
    "JohnDoeScoreEffect"
}, "rubyScoreEffect", function(value)
    RubyScoreEffectSelected = tostring(value)
